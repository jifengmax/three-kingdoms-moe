...
export declare const ApiV1PublisherRemoveMemberResponseSchema: import("arktype/internal/variants/object.ts").ObjectType<{
    ok: true;
    publisherId: string;
    handle: string;
    removed: boolean;
...
export type ApiV1PublisherRemoveMemberResponse = (typeof ApiV1PublisherRemoveMemberResponseSchema)[inferred];
...
export declare const ApiV1PublisherRecoveryResponseSchema: import("arktype/internal/variants/object.ts").ObjectType<{
    ok: true;
    dryRun: boolean;
    recovered: boolean;
    publisherId: string;
...
export type ApiV1PublisherRecoveryResponse = (typeof ApiV1PublisherRecoveryResponseSchema)[inferred];
export declare const ApiV1OfficialPublisherListResponseSchema: import("arktype/internal/variants/object.ts").ObjectType<{
    ok: true;
    items: {
...
export type ApiV1OfficialPublisherListResponse = (typeof ApiV1OfficialPublisherListResponseSchema)[inferred];
export declare const ApiV1OfficialPublisherUpdateResponseSchema: import("arktype/internal/variants/object.ts").ObjectType<{
    ok: true;
    publisherId: string;
    handle: string;
    added?: boolean | undefined;
    removed?: boolean | undefined;
    officialPublisherId?: string | undefined;
}, {}>;
export type ApiV1OfficialPublisherUpdateResponse = (typeof ApiV1OfficialPublisherUpdateResponseSchema)[inferred];
